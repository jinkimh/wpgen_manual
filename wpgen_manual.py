...
# 메인 함수
def main():
    parser = argparse.ArgumentParser(description="Generate a path from a map image.")
    parser.add_argument('image_path', type=str, help="Path to the input map image file.")
